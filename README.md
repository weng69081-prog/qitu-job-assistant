...
本项目的开发过程展示了以下技术能力与实践经验：

### 🤖 人与 AI 双脑协作
一个人 + AI 智能体团队，贯穿从需求分析、架构设计、前端开发、后端开发到测试上线的全流程。AI 承担编码执行与方案建议，人类负责决策判断与方向把控，形成高效的「双脑开发」模式。

### 🧩 多智能体 AI 系统集成
整合大模型 API（小米 MiMo + SiliconFlow 双供应商）实现多场景 AI 能力：
- **AI 职业推荐**：基于用户画像智能匹配
- **对话式面试官**：动态追问、多轮交互
- **实时表情分析**：摄像头捕捉面部特征，判断面试状态
- **AI 简历优化**：针对目标岗位智能润色
- **成长路径自动生成**：含证书、学习资源、任务清单

### 🎨 全栈工程能力
- **前端**：Vue 3 + Vue Router + Pinia + Element Plus，响应式布局 + 淡入动画 + SVG 图标系统
- **后端**：FastAPI 异步架构，12+ 模块化路由，统一 LLM 调用封装
- **数据库**：SQLite + SQLAlchemy，多表关联、事务处理
- **部署**：本地开发服务器，API 健康检查，模型降级切换

### 🐱 交互设计创新
- 设计系统：灰蓝主色调 + 咖啡辅色 + 焦橘点缀色，渐变顶部导航
- 吉祥物「小橘」：可拖拽、双击换装、定时鼓励，陪伴式求职体验
- 三级职业图谱 + 收藏体系：职业 / 视频 / 面试题 / 笔试分类收藏整合

### 📊 工程管理
- GitHub 版本控制，README 文档完善
- 功能截图、项目背景、技术栈文档齐全
